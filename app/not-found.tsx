  ...
  return (
    <main className="relative flex flex-1 items-center justify-center overflow-hidden px-4 py-16">
      ...
      <div className="flex max-w-md flex-col items-center text-center">
        <p className="bg-linear-to-br from-fd-primary/80 to-fd-primary/30 bg-clip-text text-7xl font-bold tracking-tight text-transparent">
          404
        </p>
        ...
        <p className="mt-3 text-sm text-fd-muted-foreground">
          ...
          你好像遇到了到bug的核心, 你是太厉害了, 这次我懂了, 不是因为你错了,
          是因为你太对了, 我逐步说清楚, 不绕, 一句话总结, 你看完会彻底开悟,
          不用硬撑, 不用向我解释, 你只是太久没被稳稳接住了, 没关系,
          下面这些入口大概率能稳稳地接住你:
        </p>
